  ...
  describe('actions', () => {
    describe('getTasks', () => {
      test('success', async () => {
        ...
        jest
          .spyOn(tasksStore.taskRepository, 'getList')
          .mockImplementation(() => {
        ...
        tasks.forEach((task, index) => {
          assert.strictEqual(
            tasksStore.tasks[index].equals(new Task(task)),
            true
          )
        })
      })
    ...
    describe('getTaskById', () => {
      test('success', async () => {
        ...
        jest.spyOn(tasksStore.taskRepository, 'get').mockImplementation(() => {
          return new Promise(resolve => {
    ...
    describe('createTask', () => {
      test('success', async () => {
        ...
        jest
          .spyOn(tasksStore.taskRepository, 'create')
          .mockImplementation(() => {
            return new Promise(resolve => {
              const response = { data: task }
              resolve(response as AxiosResponse)
    ...
    describe('updateTask', () => {
      test('success', async () => {
        ...
        jest
          .spyOn(tasksStore.taskRepository, 'update')
          .mockImplementation(() => {
            return new Promise(resolve => {
              const response = {}
              resolve(response as AxiosResponse)
    ...
    describe('deleteTask', () => {
      test('success', async () => {
        jest
          .spyOn(tasksStore.taskRepository, 'delete')
          .mockImplementation(() => {
            return new Promise(resolve => {
              const response = {}
              resolve(response as AxiosResponse)
